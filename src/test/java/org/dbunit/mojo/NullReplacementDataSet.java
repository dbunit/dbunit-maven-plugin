...
/**
 * Test-only {@link ReplacementDataSet} subclass that maps the {@code [NULL]}
 * token to SQL {@code NULL}. Used to verify the {@code replacementDataSetClass}
 * parameter in the plugin mojos.
 */
