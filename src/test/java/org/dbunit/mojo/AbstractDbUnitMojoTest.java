...
public abstract class AbstractDbUnitMojoTest extends TestCase
{
    ...
    protected void populateMojoCommonConfiguration(
            final AbstractDbUnitMojo mojo)
    {
        // populate parameters
        ...
        mojo.dataTypeFactoryName = p.getProperty("dataTypeFactory",
                "org.dbunit.dataset.datatype.DefaultDataTypeFactory");
        mojo.metadataHandlerName = p.getProperty("metadataHandler",
                "org.dbunit.database.DefaultMetadataHandler");
        mojo.supportBatchStatement =
                getBooleanProperty("supportBatchStatement");
        mojo.useQualifiedTableNames =
                getBooleanProperty("useQualifiedTableNames");
    ...
    {
        return Boolean.valueOf(p.getProperty(key, "false"));
    }
